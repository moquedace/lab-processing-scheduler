      ...
      <div class="about-lab-card">
        ...
        <div class="about-meta-grid">
          ...
          <div>
            ...
            <strong>Prof. Dr. José Alexandre Melo Demattê</strong>
          </div>
      ...
      <div class="status-grid">
        <article class="computer-card available-card">
          <div class="computer-card-header">
            <div>
              <h3>Super 1</h3>
              <span>Alto desempenho com GPU</span>
            </div>
          ...
          <p>
            Indicado para processamentos pesados gerais, rotinas em R,
            análises espaciais, tarefas com uso de GPU e fluxos que demandam
        ...
        <article class="computer-card busy-card">
          <div class="computer-card-header">
            <div>
              <h3>Super 2</h3>
              <span>Alta memória e CPU intensiva</span>
            </div>
          ...
          <p>
            Prioritário para processamentos críticos, tarefas com alta demanda
            de memória, modelagens paralelas, mosaicos raster extensos e rotinas
            que não rodam adequadamente no Super 1.
          </p>
    ...
    <section class="content-section">
        ...
        <article class="spec-card">
          <div class="spec-card-top">
            <div>
              ...
              <h3>Estação de alto desempenho com GPU</h3>
            </div>

            <div class="spec-chip">GPU disponível</div>
          </div>
          ...
          <div class="spec-metrics">
            ...
            <div>
              ...
              <strong>Aproximadamente 26,4 TB</strong>
            </div>
          </div>
          ...
          <div class="best-use">
            ...
            <p>
              Processamento espacial, modelagens intermediárias, tarefas com GPU,
              organização de grandes bases, rotinas em R e processamentos longos
              com alta demanda de armazenamento.
            </p>
          </div>
        </article>
        ...
        <article class="spec-card featured">
          <div class="spec-card-top">
            <div>
              ...
              <h3>Estação de maior capacidade computacional</h3>
            </div>
          ...
          <div class="spec-metrics">
            ...
            <div>
              <span>Sistema</span>
              <strong>64 bits, arquitetura x64</strong>
            </div>
          </div>
          ...
          <div class="best-use">
            <span>Melhor uso</span>
            <p>
              Modelagens pesadas, processamento paralelo intensivo, grandes
              mosaicos raster, predições espaciais em larga escala e tarefas
              com alta demanda de memória.
            </p>
          </div>
        </article>
      </div>
      ...
      <div class="recommendation-card">
        ...
        <p>
          ...
          muitos núcleos de CPU ou execução paralela intensiva. Para tarefas
          gerais, uso de GPU, organização de grandes bases e rotinas longas,
          o Super 1 pode ser a escolha mais adequada.
        </p>
      </div>
    </section>
      ...
      <div class="booking-card">
        ...
        <div class="iframe-placeholder">
          <div>
            ...
            <p>
              Campos futuros: nome, e-mail, categoria, computador desejado,
              data, horário, duração, tipo de processamento, uso de GPU,
              necessidade obrigatória do Super 2 e justificativa.
            </p>
          </div>
        </div>
      </div>
