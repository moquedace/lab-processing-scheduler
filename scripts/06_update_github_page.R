...
render_spec <- function(spec) {
  paste0(
    '              <div>
                <span class="spec-label">', escape_html(spec$label), '</span>
                <strong>', escape_html(spec$value), '</strong>
              </div>'
  )
}

render_computer_card <- function(computer) {
  specs_html <- paste(
    vapply(computer$specs, render_spec, character(1)),
    collapse = "\n"
  )
  
  paste0(
    '          <article class="', escape_html(computer$card_class), '">
            <div class="machine-top">
              <div>
                <span class="spec-label">', escape_html(computer$name), '</span>
                <h3>', escape_html(computer$title), '</h3>
              </div>
              <span class="', escape_html(computer$badge_class), '">', escape_html(computer$badge), '</span>
            </div>
            <p>
              ', escape_html(computer$description), '
            </p>
            <div class="spec-grid">
', specs_html, '
            </div>
...
computer_names_text <- paste(
  vapply(computers, function(computer) computer$name, character(1)),
  collapse = " e "
)
...
<head>
  ...
  <link rel="apple-touch-icon" href="assets/img/logo_geocis.png">
  ...
  <style>
    ...
    * {
    ...
    .button-primary {
      ...
      box-shadow: 0 12px 28px rgba(23, 76, 120, 0.24);
    }
    ...
    .button-secondary {
      color: var(--primary);
      border-color: rgba(23, 76, 120, 0.2);
      background: var(--surface);
    }

    .hero-band {
      background:
        linear-gradient(90deg, rgba(11, 43, 69, 0.94), rgba(23, 76, 120, 0.86)),
        url("assets/img/logo_geocis.png") right 8vw center / min(380px, 45vw) no-repeat;
      color: #ffffff;
    }
    ...
    .section {
      padding: 68px 0;
      border-top: 1px solid rgba(225, 232, 240, 0.72);
    }
    ...
    .machine-card.featured {
      border-color: rgba(23, 76, 120, 0.32);
    }
...
<body>
  <header class="site-header">
    <div class="header-inner">
      <a class="brand" href="#top" aria-label="GeoCiS">
        <img src="assets/img/logo_geocis.png" alt="GeoCiS">
        <span>
          GeoCiS
          <strong>Reserva dos Computadores de Processamento</strong>
        </span>
      </a>
      ...
      <div class="hero">
        <div class="hero-copy">
          ...
          <div class="hero-actions">
            ...
            <a class="button button-secondary" href="#infraestrutura">Conhecer infraestrutura</a>
          </div>
        </div>
...
', hero_machine_rows, '
    ...
    <section class="section white" aria-label="Instituições">
      <div class="logo-strip">
        ...
        <div class="support">
          <span class="mini-label">Apoio</span>
          <img src="assets/img/logo_fapesp.png" alt="FAPESP" class="logo-fapesp">
        </div>
      </div>
    </section>

    <section id="acesso" class="section">
    ...
    <section id="infraestrutura" class="section white">
      <div class="section-inner">
        <div class="section-heading">
          <div>
...
', machine_cards_html, '
    ...
    <section id="governanca" class="section white">
      <div class="section-inner">
        <div class="section-heading">
          <div>
    ...
    <section class="cta-band">
      <div class="cta">
        <div>
          <h2>Pronto para consultar ou solicitar uma reserva?</h2>
          <p>
            O sistema funcional abre em uma nova aba e concentra todo o fluxo operacional de reservas.
          </p>
        </div>
        <a class="button button-primary" href="', shiny_app_url, '" target="_blank" rel="noopener noreferrer">Abrir sistema Shiny</a>
      </div>
    </section>
  </main>
  ...
  <footer class="footer">
    <div class="footer-inner">
      ...
      <div class="footer-support">
        <span>Apoio</span>
        <img src="assets/img/logo_fapesp.png" alt="FAPESP">
      </div>
    </div>
  </footer>
</body>
...
writeLines(enc2utf8(html_content), index_file, useBytes = TRUE)
